...
<head>
    ...
    $ogTitle = "Hawaii Adventure Diving - Cage Free Shark Diving and Whale Watching Tours - Oahu, Hawaii";
    $pageDescription = "A team comprised of Hawaii's top shark handlers, offers unrivaled expertise in shark behavior and safety for truly immersive and interactive experiences.";
    $pageURL = "https://hawaiiadventurediving.com/";
        ...
        <section id="product-cards" class="dark-background">
            ...
            <div class="content-wrap py-40 jarallax" data-jarallax data-speed="0.8">
                <div class="container">
                    ...
                    <div class="row text-center" data-show="startbox">
                        <div class="col-lg-10 offset-lg-1">
                            <p>Hawaii Adventure Diving have some of the <a href="/about-us/">top shark handlers in Hawaii and even the world</a>. They possess an exceptionally high understanding of how to safely handle and redirect sharks as well as understanding there behavior, body language and how to appropriately behave around them in all scenarios. This high level of experience and understanding allows us to provide our guests with a <a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/">maximum level of freedom</a> to <a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/">swim and dive with sharks,</a> facilitating immersive and interactive experiences that extend beyond mere observation. <a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/">Dive with us,</a> and witness the remarkable difference as compared to standard tours.</p>
                        </div>
                    </div>
                    ...
                    <div class="row mini-section text-center" data-show="startbox">
                        <div class="col-lg-8 offset-lg-2">
                            <a href="/contact-custom-charters/" target="_blank"><img src="/images/custom-charters-film-crew-feature-img-small-v2.png" alt=""></a>
                            <h2>For Film Crews: Custom Charters</h2>
                            <p class="mb-10">Connect with our world-class team of <a href="/about-us/">shark diving experts and multimedia professionals</a> to charter your next film project. You can count on our rich experience and industry know-how to help you capture the footage <span class="no-break">you envision.</span></p>
                            <a class="btn btn-accent-1 btn-md" href="/contact-custom-charters/">Learn More</a>
                        </div>
                    </div>
                    ...
                    <div id="customer-reviews" class="row">
                        ...
                        <div class="col-lg-8 offset-lg-2 text-center mb-30">
                            ...
                            <p data-show="startbox">Read real reviews by our customers telling why they love Hawaii Adventure Diving and why you should choose use for your next <a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/">cage free shark <span class="no-break">diving experience.</span></a></p>
                        </div>
                        <div class="col">
                        ...
                        <div id="around-the-web" class="container text-center pb-20">
                            ...
                            <div class="row ratings-group">
                                <div class="review-block col-6 col-sm-3 col-md-2 offset-md-1" data-show="startbox" data-show-delay="200">
                                    <h4>Google</h4>
                                    <h1><?php echo $platformRatings['Google']['average']; ?><span>/5</span></h1>
                                    <img class="five-stars" src="/images/5-stars.png" alt="5 star review">
                                    <p><a href="https://bit.ly/3OSCaCX" target="_blank"><?php echo $platformRatings['Google']['total']; ?> reviews</a></p>
                                </div>
                                <div class="review-block col-6 col-sm-3 col-md-2" data-show="startbox" data-show-delay="300">
                                    <h4>Trip Advisor</h4>
                                    <h1><?php echo $platformRatings['TripAdvisor']['average']; ?><span>/5</span></h1>
                                    <img class="five-stars" src="/images/5-stars.png" alt="5 star review">
                                    <p><a href="https://www.tripadvisor.com/Attraction_Review-g60647-d7625529-Reviews-Hawaii_Adventure_Diving-Haleiwa_Oahu_Hawaii.html" target="_blank"><?php echo $platformRatings['TripAdvisor']['total']; ?> reviews</a></p>
                                </div>
                                <div class="review-block col-6 col-sm-3 col-md-2" data-show="startbox" data-show-delay="400">
                                    <h4>Groupon</h4>
                                    <h1><?php echo $platformRatings['Groupon']['average']; ?><span>/5</span></h1>
                                    <img class="five-stars" src="/images/5-stars.png" alt="5 star review">
                                    <p><a href="https://www.groupon.com/deals/hawaii-adventure-diving-3" target="_blank"><?php echo $platformRatings['Groupon']['total']; ?> reviews</a></p>
                                </div>
                                <div class="review-block col-6 col-sm-3 col-md-2" data-show="startbox" data-show-delay="500">
                                    <h4>Yelp</h4>
                                    <h1><?php echo $platformRatings['Yelp']['average']; ?><span>/5</span></h1>
                                    <img class="five-stars" src="/images/5-stars.png" alt="5 star review">
                                    <p><a href="https://www.yelp.com/biz/hawaii-adventure-diving-haleiwa-2" target="_blank"><?php echo $platformRatings['Yelp']['total']; ?> reviews</a></p>
                                </div>
                                <div class="review-block col-6 offset-3 col-sm-12 offset-sm-0 col-md-2" data-show="startbox" data-show-delay="600">
                                    <h4>Facebook</h4>
                                    <h1><?php echo $platformRatings['Facebook']['average']; ?><span>/5</span></h1>
                                    <img class="five-stars" src="/images/5-stars.png" alt="5 star review">
                                    <p><a href="https://www.facebook.com/HawaiiAdventureDiving/reviews/?ref=page_internal" target="_blank"><?php echo $platformRatings['Facebook']['total']; ?> reviews</a></p>
                                </div>
                        ...
                        <div class="row isotope-grid g-30">
                            <div class="isotope-item col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="0">
                                ...
                                <div class="service-box lift position-relative rounded-4 bg-white text-center service-box-sm">
                                    ...
                                    <p class="service-box-text font-size-15 mb-0">Total tour time is about 2 hours round trip from the harbor and back.</p><a class="stretched-link" href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/"></a>
                                </div>
                            </div>
                            <div class="isotope-item col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="100">
                                ...
                                <div class="service-box lift position-relative rounded-4 bg-white text-center service-box-sm">
                                    ...
                                    <p class="service-box-text font-size-15 mb-0">Freediving / snorkeling, swim with the sharks in the open water, no cage.</p><a class="stretched-link" href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/"></a>
                                </div>
                            </div>
                            <div class="isotope-item col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="200">
                                ...
                                <div class="service-box lift position-relative rounded-4 bg-white text-center service-box-sm">
                                    ...
                                    <p class="service-box-text font-size-15 mb-0">Expert safety provided by licensed Captains & Dive Masters.</p><a class="stretched-link" href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/"></a>
                                </div>
                            </div>
                            <div class="isotope-item col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="300">
                                ...
                                <div class="service-box lift position-relative rounded-4 bg-white text-center service-box-sm">
                                    ...
                                    <p class="service-box-text font-size-15 mb-0">All you need is an adventurous spirit. We'll handle the rest!</p><a class="stretched-link" href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/"></a>
                                </div>
                            </div>
                            ...
                            <div class="isotope-item col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="400">
                                ...
                                <div class="service-box lift position-relative rounded-4 bg-white text-center service-box-sm">
                                    ...
                                    <p class="service-box-text font-size-15 mb-0">Our tours have a minimum group size of 4 and a maximum of 6 patrons.</p><a class="stretched-link" href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/"></a>
                                </div>
                            </div>
                            ...
                            <div class="isotope-item col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="500">
                                ...
                                <div class="service-box lift position-relative rounded-4 bg-white text-center service-box-sm">
                                    ...
                                    <p class="service-box-text font-size-15 mb-0">Encounter sharks, dolphins, sea turtles and other pelagic creatures.</p><a class="stretched-link" href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/"></a>
                                </div>
                            </div>
                            <div class="isotope-item col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="600">
                                ...
                                <div class="service-box lift position-relative rounded-4 bg-white text-center service-box-sm">
                                    ...
                                    <p class="service-box-text font-size-15 mb-0">Experience stunning views. Bring your own camera gear or rent a GoPro from us!</p><a class="stretched-link" href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/"></a>
                                </div>
                            </div>
                            <div class="isotope-item col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="700">
                                ...
                                <div class="service-box lift position-relative rounded-4 bg-white text-center service-box-sm">
                                    ...
                                    <p class="service-box-text font-size-15 mb-0">Discover a deeper understanding of the ocean and its inhabitants.</p><a class="stretched-link" href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/"></a>
                                </div>
                            </div>
                    ...
                    <div class="row gy-30">
                        ...
                        <div class="col-12 col-md-6 col-lg-3" data-show="startbox">
                            <ul class="list m-0 fw-medium font-size-15">
                                <li class="active"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">Tours provided in English</a></li>
                                <li class="active mt-30"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">5 years old minimum age</a></li>
                                <li class="active mt-30"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">Shark dives available year round</a></li>
                            </ul>
                        </div><!-- Items-->
                        <div class="col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="100">
                            <ul class="list m-0 fw-medium font-size-15">
                                <li class="active"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">No diving experience necessary</a></li>
                                <li class="active mt-30"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">Free parking at dock</a></li>
                                <li class="active mt-30"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">Kama'aina & military discounts available</a></li>
                            </ul>
                        </div><!-- Items-->
                        <div class="col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="200">
                            <ul class="list m-0 fw-medium font-size-15">
                                <li class="active"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">Includes cleaned & sanatized snorkel gear</a></li>
                                <li class="active mt-30"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">No SCUBA, snorkeling only</a></li>
                                <li class="active mt-30"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">Learn freediving basics</a></li>
                            </ul>
                        </div><!-- Items-->
                        <div class="col-12 col-md-6 col-lg-3" data-show="startbox" data-show-delay="300">
                            <ul class="list m-0 fw-medium font-size-15">
                                <li class="active"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">Personal photography encouraged</a></li>
                                <li class="active mt-30"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">GoPro rentals available</a></li>
                                <li class="active mt-30"><a href="/shark-diving-tours/hawaii/oahu/north-shore-haleiwa/cage-free-shark-diving-tour/" class="link-plain">Learn about sharks, Hawaii, Ecology & Conservation</a></li>
                            </ul>
                        </div>
                    </div>
                    <!--// Shark Tour Overview Smaller List items -->
