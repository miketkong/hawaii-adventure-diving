    ...
    <div class="content-wrap main-content inner-page bg-lightrays">
        <div class="container">
            ...
            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-dolphins.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Hawaiian Spinner Dolphins</h2>
                    <h3>Stenella longirostris</h3>
                    <p>The spinner dolphin (Stenella longirostris) is a small dolphin found in off-shore tropical waters around the world. It is famous for its acrobatic displays in which it rotates around its longitudinal axis as it leaps through the air. It is a member of the family Delphinidae of toothed whales.</p>
            ...
            <div class="row listable-content-card gx-0" data-show="startbox">
                ...
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Hawaiian Green Sea Turtle</h2>
                    <h3>Chelonia mydas</h3>
                    <p>Also known as the green turtle, is a species of large sea turtle of the family Cheloniidae. It is the only species in the genus Chelonia. Its range extends throughout tropical and subtropical seas around the world, with two distinct populations in the Atlantic and Pacific Oceans, but it is also found in the Indian Ocean.</p>
            ...
            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-humpback-whale-and-calf.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
            ...
            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-wedge-tailed-shearwater.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Wedge-tailed Shearwater</h2>
                    <h3>Ardenna pacifica</h3>
                    <p>The wedge-tailed shearwater is a medium-large shearwater in the seabird family Procellariidae. It ranges throughout the tropical Pacific and Indian Oceans and breeds on islands off Japan, on the Islas Revillagigedo, the Hawaiian Islands, the Seychelles, the Northern Mariana Islands, and off Eastern and Western Australia.</p>
                    <p>edge-tailed shearwaters are monogamous, forming a pair bond that lasts for several years. Both sexes undertake a prelaying exodus to build up energy reserves; this usually lasts around 28 days. A single egg is laid, if that egg is lost, then the pair will not attempt another that season.</p>
                </div>
            </div>

            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-octopus.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Octopus</h2>
                    <h3>Octopus cyanea</h3>
                    <p>An octopus is a soft-bodied, eight-limbed mollusc of the order Octopoda. The soft body can radically alter its shape, enabling octopuses to squeeze through small gaps. They have a complex nervous system and excellent sight, and are among the most intelligent and behaviourally diverse of all invertebrates.</p>
                    <p>Maze and problem-solving experiments have shown evidence of a memory system that can store both short- and long-term memory. Young octopuses learn nothing from their parents, as adults provide no parental care beyond tending to their eggs until the young octopuses hatch.</p>
                </div>
            </div>

            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-mahi-mahi.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Mahi Mahi (Dorado, Dolfinfish)</h2>
                    <h3>Coryphaena hippurus</h3>
                    <p>The mahi-mahi or common dolphinfish is a surface-dwelling ray-finned fish found in off-shore temperate, tropical, and subtropical waters worldwide. Also widely called dorado (not to be confused with Salminus brasiliensis, a fresh water fish) and dolphin, it is one of two members of the family Coryphaenidae, the other being the pompano dolphinfish. These fish are most commonly found in the waters around the Gulf of Mexico, Costa Rica, Hawaii and the Indian Ocean.</p>
                    <p>Mahi-mahi are highly sought for sport fishing and commercial purposes. Sport fishermen seek them due to their beauty, size, food quality, and healthy population.</p>
                </div>
            </div>

            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-monk-seal.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
            ...
            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-box-jelly.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Jellyfish</h2>
                    <p>Jellyfish and sea jellies are the informal common names given to the medusa-phase of certain gelatinous members of the subphylum Medusozoa, a major part of the phylum Cnidaria. Jellyfish are mainly free-swimming marine animals with umbrella-shaped bells and trailing tentacles, although a few are anchored to the seabed by stalks rather than being mobile.</p>
                    <p>There are a variety of types of jellyfish found in the waters of Hawai'i including the box jelly, moon jelly, and spotted jelly.</p>
                </div>
            </div>

            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-iwa-bird.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Iwa Bird</h2>
                    <h3>Fregata minor</h3>
                    <p>The iwa bird has a wide distribution throughout the world's tropical seas. Hawaii is the northernmost extent of their range in the Pacific Ocean, with around 10,000 pairs nesting mostly in the Northwestern Hawaiian Islands.</p>
                    <p>It forages in pelagic waters within 50 mi (80 km) of the breeding colony or roosting areas. Flying fish from the family Exocoetidae are the most common item in the diet of the great frigatebird; other fish species and squid may be eaten as well.</p>
                </div>
            </div>

            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/hawaii-adventure-diving-barracuda.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Barracuda</h2>
                    <h3></h3>
                    <p>A barracuda, or cuda for short, is a large, predatory, ray-finned fish known for its fearsome appearance and ferocious behaviour. They are opportunistic predators, relying on surprise and short bursts of speed, up to 27 mph (43 km/h), to overtake their prey.</p>
                    <p>Barracudas are usually found swimming in saltwater searching for schools of plankton-feeding fish. Their silver and elongated bodies make them difficult for prey to detect, and even more difficult to be seen when viewing them head-on.</p>
                </div>
            </div>
