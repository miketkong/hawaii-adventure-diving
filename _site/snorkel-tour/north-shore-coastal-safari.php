...
<body class="has-topbar snorkel-tour-page tour-page bg-white">
    <!-- nav.php include -->
    <?php
    ...
    <div class="content-wrap">
        <section id="page-banner" class="hero-video-banner hero-banner">
            <div class="container-fluid gx-0">
                ...
                <?php include $_SERVER['DOCUMENT_ROOT'] . '/assets/includes/video-banner-snorkel.php' ?>
                ...
                <div class="banner-contents">
                    ...
                    <div class="page-title-img-wrapper">
                        <h1>A Snorkel Adventure</h1>
                        <img src="/images/page-title-north-shore-coastal-safari.png" alt="North Shore Coastal Safari">
                    </div>
        ...
        <section id="pano-banner-snorkel-1" class="pano-section white-text text-left">
            <div class="container-fluid gx-0">
                ...
                <div class="section-content">
                    ...
                    <div class="text-box">
                        <h1 class="h1-small-leader-text">Snorkel Tour Oahu</h1>
                        <h2>A Snorkeling Adventure</h2>
                        <p>Embark on a breathtaking journey along Oahu's North Shore with our exclusive North Shore Coastal Safari snorkeling tour. Dive into the crystal-clear waters and come face-to-face with some of Hawaii's most enchanting marine life, including the majestic Hawaiian green sea turtles and vibrant reef fish.</p>
                    </div>
                </div>
            </div>
        </section>
