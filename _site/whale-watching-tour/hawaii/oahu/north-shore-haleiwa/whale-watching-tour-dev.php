            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 text-center-md">
                        ...
                        <p>All whale watching tours are 6 person maximum reserved by group and 2 hours in length. Reserve your tour today!</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                            ...
                            <div class="col-md-4 offset-lg-4">
                                <div class="product-card">
                                    ...
                                    <div class="text">
                                        ...
                                        <h3 class="price">$525-$575<br><span class="sub-text">(Plus taxes & fees)</span></h3>
