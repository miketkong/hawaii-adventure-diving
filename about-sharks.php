    ...
    <div class="content-wrap main-content inner-page bg-lightrays">
        <div class="container">
            ...
            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/grey-reef-shark-group.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
            ...
            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/scalloped-hammerhead-shark-with-fish.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Scalloped Hammerheads</h2>
                    <h3>Sphyrna lewini</h3>
                    <p>The scalloped hammerhead is a species of hammerhead shark in the family Sphyrnidae. It was originally known as Zygaena lewini. The Greek word sphyrna translates into "hammer" in English, referring to the shape of this shark's head, which is its most distinguishing characteristic.</p>
                    <p>The shark's eyes and nostrils are at the tips of the extensions. It is a fairly large hammerhead, but is still smaller than both the great and smooth hammerheads.</p>
                </div>
            </div>

            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/smooth-hammerhead.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Smooth Hammerhead</h2>
                    <h3>Sphyrna zygaena</h3>
                    <p>The smooth hammerhead is a species of hammerhead shark in the family Sphyrnidae. It was originally known as Zygaena lewini. This species is named "smooth hammerhead" because of the distinctive shape of the head, which is flattened and laterally extended into a hammer shape (called the "cephalofoil"), without an indentation in the middle of the front margin (hence "smooth").</p>
                    <p>Unlike other hammerheads, this species prefers temperate waters and occurs worldwide at medium latitudes. In the summer, these sharks migrate towards the poles following cool water masses, sometimes forming schools numbering in the hundreds to thousands.</p>
                </div>
            </div>

            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/silky-shark.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Silky Shark</h2>
                    <h3>Carcharhinus falciformis</h3>
                    <p>Also known by numerous names such as blackspot shark, gray whaler shark, olive shark, ridgeback shark, sickle shark, sickle-shaped shark and sickle silk shark, is a species of requiem shark, in the family Carcharhinidae, named for the smooth texture of its skin.</p>
                    <p>It is one of the most abundant sharks in the pelagic zone, and can be found around the world in tropical waters.</p>
                </div>
            </div>

            <div class="row listable-content-card gx-0" data-show="startbox">
                <div class="col-lg-7 order-lg-2">
                    <img src="/images/sandbar-shark.webp" alt="">
                </div>
                <div class="col-lg-5 pr-lg-30 order-lg-1">
                    <h2>Sandbar Shark</h2>
                    <h3>Carcharhinus plumbeus</h3>
                    <p>Also known as the brown shark or thickskin shark, is a species of requiem shark, and part of the family Carcharhinidae, native to the Atlantic Ocean and the Indo-Pacific. It is distinguishable by its very high first dorsal fin and interdorsal ridge. It is not to be confused with the similarly named sand tiger shark, or Carcharias taurus.</p>
                    <p>In spite of their large size and similar appearance to other dangerous sharks such as bull sharks, Sandbars are not considered to be dangerous to people. Very few, if any attacks are attributed to sandbar sharks. As a result, they are considered one of the safest sharks to swim with and are popular sharks for aquaria.</p>
                </div>
            </div>
