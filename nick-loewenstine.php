        ...
        <div class="container">
            ...
            <div class="row pb-40 text-center">
                <div class="col-lg-12" data-show="startbox" data-show-delay="200">
                    <h1 class="h1-giant-heading desktop-only">Thriving On Adventure</h1>
                    <img class="mobile-only full-width pb-10" src="/images/headline-thriving-mobile-square.png" alt="Thriving On Adventure">
                </div>
                <div class="col-lg-12" data-show="startbox" data-show-delay="200">
                    <p class="giant-subheading">Immerse Yourself with Nick Loewenstine: Renowned Shark Diver, Photographer, Owner of Hawaii Adventure Diving, and Guardian <span class="no-break">of the Deep.</span></p>
                </div>
            </div>
