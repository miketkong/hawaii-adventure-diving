    ...
    <div class="content-wrap main-content inner-page bg-lightrays dark-background">
        ...
        <div class="container">
            ...
            <div class="row listable-content-card gx-0" data-show="startbox" data-show-delay="300">
                <div class="col-lg-5">
                    <div class="img-wrapper">
                        <a href="/articles/shark-diving-hawaii/shark-diving-oahu-what-its-like.php"><img src="/articles/images/2024/article-feature-img-shark-diver-holding-safety-rope.jpg" alt="A Hawaii shark diving tour free diver holds onto a safety rope while a shark swims by." loading="lazy"></a>
                    </div>
                </div>
                <div class="col-lg-7 pl-lg-30">
                    <h2><a href="/articles/shark-diving-hawaii/shark-diving-oahu-what-its-like.php">
                    ...
                    <div><a class="btn btn-accent-1 big-button" href="/articles/shark-diving-hawaii/shark-diving-oahu-what-its-like.php">Read more</a></div>
                </div>
            </div>
            <!--// ARTICLE ENTRY -->
            ...
            <div class="row listable-content-card gx-0" data-show="startbox" data-show-delay="300">
                <div class="col-lg-5">
                    <div class="img-wrapper">
                        <a href="/articles/shark-diving-hawaii/hawaii-north-shore-oahu-what-its-like.php"><img src="/articles/images/2024/haleiwa-drone-shot-bridges-iStock-1205393332-square.jpg" alt="A drone shot of the Haleiwa bridge and harbor from above." loading="lazy"></a>
                    </div>
                </div>
                <div class="col-lg-7 pl-lg-30">
                    <h2><a href="/articles/shark-diving-hawaii/hawaii-north-shore-oahu-what-its-like.php">
                    ...
                    <div><a class="btn btn-accent-1 big-button" href="/articles/shark-diving-hawaii/hawaii-north-shore-oahu-what-its-like.php">Read more</a></div>
                </div>
            </div>
            <!--// ARTICLE ENTRY -->
            ...
            <div class="row listable-content-card gx-0" data-show="startbox" data-show-delay="300">
                <div class="col-lg-5">
                    <div class="img-wrapper">
                        <a href="/articles/shark-diving-hawaii/sammy-swimming-with-a-giant-tiger-shark-november-2023.php"><img src="/articles/images/2023/november/feature-img-sammy-falgiani-swimming-with-tiger-shark-2023.jpg" alt="Photo of Hawaii Adventure Diving Sammy Falgiani swimming next to a huge tiger shark." loading="lazy"></a>
                    </div>
                </div>
                <div class="col-lg-7 pl-lg-30">
                    <h2><a href="/articles/shark-diving-hawaii/sammy-swimming-with-a-giant-tiger-shark-november-2023.php">Shark Diving Weekly Top Moments: Sammy Falgiani's Giant <span class="no-break">Tiger</span></a></h2>
                    ...
                    <div><a class="btn btn-accent-1 big-button" href="/articles/shark-diving-hawaii/sammy-swimming-with-a-giant-tiger-shark-november-2023.php">Read more</a></div>
                </div>
            </div>
            <!--// ARTICLE ENTRY -->
            ...
            <div class="row listable-content-card gx-0" data-show="startbox" data-show-delay="300">
                <div class="col-lg-5">
                    <div class="img-wrapper">
                        <a href="/articles/shark-diving-hawaii/savas-tiger-shark-diving-photos-from-2023.php"><img src="/articles/images/2023/october/article-feature-savas-tiger-shark-season-photos-2023.jpg" alt="Photo of Hawaii Adventure Diving boat captain, Stacy Lieser snorkeling next to a large tiger shark." loading="lazy"></a>
                    </div>
                </div>
                <div class="col-lg-7 pl-lg-30">
                    <h2><a href="/articles/shark-diving-hawaii/savas-tiger-shark-diving-photos-from-2023.php">Sava's Tiger Shark Diving Photos <span class="no-break">from 2023</span></a></h2>
                    ...
                    <div><a class="btn btn-accent-1 big-button" href="/articles/shark-diving-hawaii/savas-tiger-shark-diving-photos-from-2023.php">Read more</a></div>
                </div>
            </div>
            <!--// ARTICLE ENTRY -->
